...
function vertexShaderPerlinNoise() {
  return `
...
function fragmentShaderPerlinNoise() {
  return `
  varying vec3 vPosition;
  uniform float scale;
...
function createPerlinNoiseShader() {
  return new ShaderMaterial ( 
      {
        uniforms: { 
          scale: { type: "f", value: -1000}
        },
        vertexShader: vertexShaderPerlinNoise(),
        fragmentShader: fragmentShaderPerlinNoise(),
        side: BackSide,
      }   
  );
}
...
export { createHaloShader, createFresnelShader, fragmentShaderFresnel, vertexShaderFresnel, createPerlinNoiseShader }
